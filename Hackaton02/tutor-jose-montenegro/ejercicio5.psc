...
//de zapatos que tiene una promoción de descuento 
//para vender al mayor, esta dependerá del número 
//de zapatos que se compren. Si son más de diez, se 
//les dará un 10% de descuento sobre el total de 
//la compra; si el número de zapatos es mayor de 
//veinte pero menor de treinta, se le otorga un 20% 
//de descuento; y si son más treinta zapatos se otorgará 
//un 40% de descuento. El precio de cada zapato es de $80

Algoritmo  determinaSiTermina4
